...
-   jasmine/jest (core concepts describe/beforeEach/afterEach/it/ (expect/matchers - will be implemented soon) and their communication on test run(will be implemented soon))
